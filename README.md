...
- ### PeerConnection
  ...
  - #### close
    Forcefully closes a peer and all its facilities, including enrolled registers and ledgers, and alerting the network of the death through the `gossipBuffer`<!---->.
  - #### stabilizeLink
