...
### Demo
  ...
  ```shell
  curl -LJo Membrane-v1.0.1.tar.gz https://github.com/Elijah-Bodden/Membrane/tarball/v1.0.1
  tar xfv Membrane-v1.0.1.tar.gz --transform 's!^[^/]\+\($\|/\)!Membrane-v1.0.1\1!'
  cd Membrane-v1.0.1/src/source/frontend
  npm install
  cd ../server
  npm install
  npm run deploy
  rm ../../../../Membrane-v1.0.1.tar.gz
  ```
